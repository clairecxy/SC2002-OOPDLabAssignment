...
public interface ReportGenerator {
    ...
    /**
     * Generates a report containing the Camp's details for the Camp.
    ...
    /**
     * Generates a report containing the Camp's attendee details for the Camp.
     * @param camp the Camp this Report Generator is generating the report for.
     * @return the String containing the report generated.
     */
    ...
    /**
     * Generates a report containing the Camp's Committee member's details for the Camp.
     * @param camp the Camp this Report Generator is generating the report for.
     * @return the String containing the report generated.
     */
    ...
    /**
     * Generates a full report containing all the Camp's details for the Camp.
     * @param camp the Camp this Report Generator is generating the report for.
     * @return the String containing the report generated.
     */
